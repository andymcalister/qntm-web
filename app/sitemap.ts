...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const staticEntries: MetadataRoute.Sitemap = [
    ...
    { url: `${SITE}/screener`, lastModified: now, changeFrequency: "daily", priority: 0.9 },
    { url: `${SITE}/signals`, lastModified: now, changeFrequency: "daily", priority: 0.9 },
    { url: `${SITE}/hidden-gems`, lastModified: now, changeFrequency: "daily", priority: 0.8 },
    { url: `${SITE}/model-portfolio`, lastModified: now, changeFrequency: "daily", priority: 0.8 },
