...
export const config = {
  matcher: ["/screener", "/screener/(.*)", "/watchlist", "/watchlist/(.*)", "/portfolio", "/portfolio/(.*)", "/model-portfolio", "/model-portfolio/(.*)", "/hidden-gems", "/hidden-gems/(.*)", "/simulator", "/simulator/(.*)", "/alerts", "/alerts/(.*)"],
};
